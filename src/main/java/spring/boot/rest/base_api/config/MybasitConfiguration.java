package spring.boot.rest.base_api.config;
 ...
 */
@Configuration
@MapperScan("spring.boot.rest.base_api.mapper")
public class MybasitConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        sqlSessionFactoryBean
                .setMapperLocations(resolver.getResources("classpath:mybatis/base_api/*.xml"));
        sqlSessionFactoryBean.setTypeAliasesPackage("spring.boot.rest.base_api.entity");
